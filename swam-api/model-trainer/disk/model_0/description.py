...
config ={
  ...
  'modelParams' : {'tmParams': {'minThreshold': 11, 'activationThreshold': 14, 'pamLength': 3}, 'sensorParams': {'encoders': {u'disk': {'maxval': 100.0, 'name': 'disk', 'clipInput': True, 'minval': 0.0, 'n': 272, 'fieldname': 'disk', 'w': 21, 'type': 'ScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.05015}, 'clParams': {'alpha': 0.050050000000000004}},

}

mod = importBaseDescription('../disk_model_store/description.py', config)
